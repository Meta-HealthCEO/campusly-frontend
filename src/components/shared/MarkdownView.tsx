...
/**
 * Plain-string markdown renderer with consistent prose styling. Mirrors the
 * styling from `content/renderers/TextBlock.tsx` so wherever we render rich
 * text (assignment briefs, lesson notes, AI output) it looks the same.
 *
 * Supports GFM (tables, task lists) and KaTeX math via `$inline$` / `$$block$$`.
 */
