          ...
          {students.map((row) => (
            ...
            >
                  ...
                  >
                    {value === null ? (
                      ...
                      <div className="inline-flex items-center gap-1">
                        <span className={cn('font-heading font-medium tabular-nums', gradeColor(value))}>{value}%</span>
              ...
              <td className="sticky right-0 z-10 bg-background px-3 py-2 text-center border-b border-l whitespace-nowrap">
                <span className={cn('font-heading font-semibold tabular-nums', gradeColor(row.overallAverage))}>
