...
import {
  Mail, MailOpen, AlertCircle, MessageSquare, Megaphone, Bell,
} from 'lucide-react';
...
export default function CommunicationPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Messages"
        description="View messages, announcements, and alerts from the school."
      />
        ...
        <CardContent>
          {messages.length > 0 ? (
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-xs text-muted-foreground shrink-0 text-right">
                      ...
                      <p className="mt-0.5">{formatDate(message.createdAt, 'dd MMM')}</p>
                    </div>
                  </div>
                );
              })}
            ...
            <EmptyState
              icon={Mail}
              title="No messages"
              description="Your inbox is empty. Messages from the school will appear here."
            />
          )}
        </CardContent>
      </Card>
            ...
            <>
              <DialogHeader>
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <Badge
                    variant="secondary"
                    className={priorityStyles[selectedMessage.priority] ?? ''}
                  >
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="text-muted-foreground">
                    {formatDate(selectedMessage.createdAt, 'dd MMM yyyy HH:mm')}
                  </div>
                </div>
                <Separator />
